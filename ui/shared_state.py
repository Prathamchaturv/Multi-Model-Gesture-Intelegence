...
class SharedState(QObject):
    ...
    def __init__(self, parent: QObject | None = None) -> None:
        ...
        self._metrics = {
            ...
            'accuracy_pct': 0.0,
            'feedback_total': 0.0,
            'feedback_correct': 0.0,
            'feedback_incorrect': 0.0,
            'feedback_accuracy_pct': 0.0,
    ...
    def set_metrics(self, metrics: dict) -> None:
        ...
        payload = {
            ...
            'feedback_total': float(metrics.get('feedback_total', 0.0)),
            'feedback_correct': float(metrics.get('feedback_correct', 0.0)),
            'feedback_incorrect': float(metrics.get('feedback_incorrect', 0.0)),
            'feedback_accuracy_pct': float(metrics.get('feedback_accuracy_pct', 0.0)),
